...
class DeploymentRunner:
    ...
    def add_open_loop_agent(self, agent, name):
        ...
        self.logger.add_robot(name, agent.cfg)
        ...
        try:
            for i in range(max_steps):
                ...
                if (i == 0) :
                    ...
                    action = self.policy(total_obs, policy_info)
                ...
                for agent_name in self.agents.keys():
                    ...
                    if agent_name == self.control_agent_name:
                        ...
                        total_obs = torch.cat( [total_obs[:, 48:], control_obs[:,:]], dim=-1)
